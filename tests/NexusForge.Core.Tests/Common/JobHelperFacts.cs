    ...
    public class JobHelperFacts
    {
        ...
        public void ForDeserializeCanUseCustomConfigurationOfJsonNet()
        {
            try
            {
                ...
                var result = (ClassA)JobHelper.FromJson<IClass>(@"{ ""$type"": ""NexusForge.Core.Tests.Common.JobHelperFacts+ClassA, NexusForge.Core.Tests"", ""propertyA"":""A"" }");
        ...
        public void ForDeserializeWithGenericMethodCanUseCustomConfigurationOfJsonNet()
        {
            try
            {
                ...
                var result = (ClassA)JobHelper.FromJson(@"{ ""$type"": ""NexusForge.Core.Tests.Common.JobHelperFacts+ClassA, NexusForge.Core.Tests"", ""propertyA"":""A"" }", typeof(IClass));
