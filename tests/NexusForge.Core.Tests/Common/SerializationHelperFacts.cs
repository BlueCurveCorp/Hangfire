...
namespace NexusForge.Core.Tests.Common
{
    public class SerializationHelperFacts
    {
        ...
        public void Serialize_ReturnsCorrectJson_WhenOptionsIsTypedInternal()
        {
            ...
            Assert.Equal(@"{""$type"":""NexusForge.Core.Tests.Common.SerializationHelperFacts+ClassA, NexusForge.Core.Tests"",""PropertyA"":""B""}", result);
        }
        ...
        public void Serialize_SerializesWithDefaultSettingsWithTypeInformation_WhenOptionIsTypedInternal_BeforeVersion170()
        {
            ...
            Assert.Equal(
                "{\"$type\":\"NexusForge.Core.Tests.Common.SerializationHelperFacts+ClassB, NexusForge.Core.Tests\"," + 
        ...
        public void Serialize_DoesNotSerializeWithUserSettings_WhenOptionsIsTypedInternal()
        {
            ...
            Assert.Equal(
                @"{""$type"":""NexusForge.Core.Tests.Common.SerializationHelperFacts+ClassA, NexusForge.Core.Tests"",""PropertyA"":""A""}",
                result);
        }
        ...
        public void Serialize_JsonDefaultSettingsAffectResult_WhenOptionIs_User()
        {
            ...
            Assert.Equal(
                "{\"$type\":\"NEXUSFORGE.CORE.TESTS.COMMON.SERIALIZATIONHELPERFACTS+CLASSB, someAssembly\",\"StringValue\":\"B\",\"DateTimeValue\":\"12041961\"}",
                result);
        }
        ...
        public void Serialize_JsonDefaultSettingsDoNotAffectResult_WhenOptionIs_TypedInternal_StartingFromVersion_170()
        {
            ...
            Assert.Equal(@"{""$type"":""NexusForge.Core.Tests.Common.SerializationHelperFacts+ClassB, NexusForge.Core.Tests"",""StringValue"":""B"",""DateTimeValue"":""1961-04-12T00:00:00""}", result);
        }
#endif
        ...
        public void Serialize_WithSpecifiedType_IncludesTypeProperty_WhenItDoesNotEqualToDeclared_AndTypeNameHandlingAutoIsUsed()
        {
            ...
            Assert.Equal("{\"$type\":\"NexusForge.Core.Tests.Common.SerializationHelperFacts+ClassA, NexusForge.Core.Tests\",\"PropertyA\":\"hello\"}", result);
        }
        ...
        {
            var valueJson = @"{""$type"":""NexusForge.Core.Tests.Common.SerializationHelperFacts+ClassA, NexusForge.Core.Tests"",""PropertyA"":""A""}";
        ...
        public void Deserialize_HandlesDeserializationUsingUserOption_WhenUsingInternalOptionThrewException()
        {
            ...
            var json = "{\"$type\":\"NEXUSFORGE.CORE.TESTS.COMMON.SERIALIZATIONHELPERFACTS+CLASSB, mscorlib\",\"StringValue\":\"B\",\"DateTimeValue\":\"\\/Date(1356044400000)\\/\"}";
        ...
        public void Deserialize_RethrowsAnException_WhenUsingInternalOptionThrewException_AndUserSettingsAttemptFailedToo()
        {
            ...
            var json = "{\"$type\":\"NEXUSFORGE.CORE.TESTS.COMMON.SERIALIZATIONHELPERFACTS+CLASSB, someAssembly\",\"StringValue\":\"B\",\"DateTimeValue\":\"12041961\"}";
