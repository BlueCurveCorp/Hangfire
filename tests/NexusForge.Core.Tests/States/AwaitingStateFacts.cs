...
namespace NexusForge.Core.Tests.States
{
    public class AwaitingStateFacts
    {
        ...
        public void SerializeData_ReturnsCorrectData_Before170()
        {
            ...
            Assert.Equal("{\"$type\":\"NexusForge.States.EnqueuedState, NexusForge.Core\",\"Queue\":\"default\",\"Reason\":null}", data["NextState"]);
        ...
        public void SerializeData_ReturnsCorrectData_After170()
        {
            ...
            Assert.Equal(state.ParentId, data["ParentId"]);
            Assert.Equal("{\"$type\":\"NexusForge.States.EnqueuedState, NexusForge.Core\",\"Queue\":\"default\"}", data["NextState"]);
        ...
        public void JsonSerialize_ReturnsCorrectString_Before170()
        {
            ...
            Assert.Equal(
                "{\"$type\":\"NexusForge.States.AwaitingState, NexusForge.Core\",\"ParentId\":\"parent\",\"NextState\":{\"$type\":\"NexusForge.States.EnqueuedState, NexusForge.Core\",\"Queue\":\"default\",\"Reason\":null},\"Options\":0,\"Reason\":null}",
                serialized);
        }
        ...
        public void JsonSerialize_ReturnsCorrectString_After170()
        {
            ...
            Assert.Equal(
                "{\"$type\":\"NexusForge.States.AwaitingState, NexusForge.Core\",\"ParentId\":\"parent\",\"NextState\":{\"$type\":\"NexusForge.States.EnqueuedState, NexusForge.Core\",\"Queue\":\"default\"}}",
                serialized);
        }
        ...
        {
            var json = "{\"$type\":\"NexusForge.States.AwaitingState, NexusForge.Core\",\"ParentId\":\"parent\",\"NextState\":{\"$type\":\"NexusForge.States.EnqueuedState, NexusForge.Core\",\"Queue\":\"default\"},\"Options\":1,\"Name\":\"Awaiting\"}";
        ...
        {
            var json = "{\"$type\":\"NexusForge.States.AwaitingState, NexusForge.Core\",\"ParentId\":\"parent\",\"NextState\":{\"$type\":\"NexusForge.States.EnqueuedState, NexusForge.Core\",\"Queue\":\"default\"}}";
            var state = SerializationHelper.Deserialize<AwaitingState>(json, SerializationOption.TypedInternal);
