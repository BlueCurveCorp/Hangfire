...
namespace NexusForge.Core.Tests.States
{
    public class EnqueuedStateFacts
    {
        ...
        public void JsonSerialize_ReturnsCorrectString_Before170()
        {
            ...
            Assert.Equal(
                "{\"$type\":\"NexusForge.States.EnqueuedState, NexusForge.Core\",\"Queue\":\"default\",\"Reason\":null}",
                serialized);
        }
        ...
        public void JsonSerialize_ReturnsCorrectString_After170()
        {
            ...
            Assert.Equal(
                "{\"$type\":\"NexusForge.States.EnqueuedState, NexusForge.Core\",\"Queue\":\"default\"}",
                serialized);
        }
        ...
        {
            var json = "{\"$type\":\"NexusForge.States.EnqueuedState, NexusForge.Core\",\"Queue\":\"default\"}";
            var state = SerializationHelper.Deserialize<EnqueuedState>(json);
        ...
        {
            var json = "{\"$type\":\"NexusForge.States.EnqueuedState, NexusForge.Core\"}";
            var state = SerializationHelper.Deserialize<EnqueuedState>(json);
