...
namespace NexusForge.Core.Tests.States
{
    public class SucceededStateFacts
    {
        ...
        public void JsonSerialize_ReturnsCorrectString_Before170()
        {
            ...
            Assert.Equal(
                "{\"$type\":\"NexusForge.States.SucceededState, NexusForge.Core\",\"Result\":null,\"Latency\":1,\"PerformanceDuration\":2,\"Reason\":null}",
                serialized);
        }
        ...
        public void JsonSerialize_ReturnsCorrectString_After170()
        {
            ...
            Assert.Equal(
                "{\"$type\":\"NexusForge.States.SucceededState, NexusForge.Core\",\"Latency\":1,\"PerformanceDuration\":2}",
                serialized);
        }
