...
namespace NexusForge.Core.Tests.States
{
    public class ScheduledStateFacts
    {
        ...
        public void JsonSerialize_ReturnsCorrectString_Before170()
        {
            ...
            Assert.Equal(
                "{\"$type\":\"NexusForge.States.ScheduledState, NexusForge.Core\",\"EnqueueAt\":" + convertedDateTime + ",\"Reason\":null}",
                serialized);
        }
        ...
        public void JsonSerialize_ReturnsCorrectString_After170()
        {
            ...
            Assert.Equal(
                "{\"$type\":\"NexusForge.States.ScheduledState, NexusForge.Core\",\"EnqueueAt\":" + convertedDateTime + "}",
                serialized);
        }
    }
}
