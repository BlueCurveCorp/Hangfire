...
using NexusForge.Core.Tests.Common;
using NexusForge.Server;
using Moq;
using Xunit;

namespace NexusForge.Core.Tests.Server
{
...
#pragma warning restore CS1998 // Async method lacks 'await' operators and will run synchronously
        ...
        public static IEnumerable<object[]> GetSchedulers()
        {
            ...
            yield return new object[] { new NexusForge.Processing.BackgroundTaskScheduler(threadCount: 1) };
        }
#endif
