...
namespace NexusForge.States
{
    ...
    /// <see cref="O:NexusForge.BackgroundJob.Enqueue">BackgroundJob.Enqueue</see>
    /// and <see cref="O:NexusForge.BackgroundJobClientExtensions.Enqueue">BackgroundJobClientExtensions.Enqueue</see>
    ...
    /// </example>
    /// 
    /// <seealso cref="O:NexusForge.BackgroundJob.Enqueue">BackgroundJob.Enqueue Overload</seealso>
    /// <seealso cref="O:NexusForge.BackgroundJobClientExtensions.Enqueue">BackgroundJobClientExtensions.Enqueue Overload</seealso>
    /// <seealso cref="O:NexusForge.BackgroundJobClientExtensions.Create">BackgroundJobClientExtensions.Create Overload</seealso>
    ...
    public class EnqueuedState : IState
    {
        ...
        public EnqueuedState([CanBeNull] string queue)
        {
            ...
            _queue = queue;
            _tenantId = NexusForgeTenantContext.CurrentTenantId;
