...
namespace NexusForge.States
{
    ...
    /// be processed after two hours. Please see <see cref="O:NexusForge.BackgroundJob.Schedule">BackgroundJob.Schedule</see>
    /// and <see cref="O:NexusForge.BackgroundJobClientExtensions.Schedule">BackgroundJobClientExtensions.Schedule</see>
    /// method overloads for simpler API.
    /// 
    /// <code lang="cs" source="..\Samples\States.cs" region="ScheduledState" />
    /// </example>
    /// 
    /// <seealso cref="O:NexusForge.BackgroundJob.Schedule">BackgroundJob.Schedule Overload</seealso>
    /// <seealso cref="O:NexusForge.BackgroundJobClientExtensions.Schedule">BackgroundJobClientExtensions.Schedule Overload</seealso>
