...
namespace NexusForge.States
{
    ...
    /// </summary>
    /// <remarks>
    /// <para>Background job processing in NexusForge is all about moving a background job
    ...
    /// NexusForge that a job should be processed by a <see cref="NexusForge.Server.Worker"/>,
    /// and <see cref="FailedState"/> tells NexusForge that a job should be investigated 
    /// by a developer.</para>
    /// 
    ...
    /// 
    /// <para>NexusForge allows you to define custom states to extend the processing
    ...
    /// ignore those exceptions. By default, NexusForge will move a job that threw
    ...
    /// define the state as a <i>final</i> one, letting NexusForge to expire faulted
    ...
    public interface IState
    {
        ...
        /// <see langword="true"/> or <see langword="false" />. NexusForge does
