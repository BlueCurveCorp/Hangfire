...
#pragma warning restore 618
            ...
            [CanBeNull] IBackgroundJobStateChanger stateChanger)
        {
            ...
            _logger.Info($"Starting NexusForge Server using job storage: '{storage}'");

            storage.WriteOptionsToLog(_logger);

            _logger.Info("Using the following options for NexusForge Server:\r\n" +
        ...
        {
            _logger.Debug("NexusForge Server is stopping...");
