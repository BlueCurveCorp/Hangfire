...
using NexusForge.Dashboard.Owin;
...
namespace NexusForge
{
    ...
    /// <remarks>
    /// 
    /// <para>This class simplifies NexusForge configuration in OWIN applications,
    ...
    /// <see href="https://www.nuget.org/packages/NexusForge.Dashboard.Authorization/">
    /// NexusForge.Dashboard.Authorization</see> package.</note>
    /// 
    /// <h3>UseNexusForgeServer</h3>
    ...
    /// <see cref="O:NexusForge.AppBuilderExtensions.UseNexusForgeDashboard"/>.</para>
    /// 
    /// <code lang="cs" source="..\Samples\AppBuilderExtensions.cs" region="Dashboard Only" />
    /// 
    /// <h3>Change Dashboard Path</h3>
    /// <para>By default, you can access Dashboard UI by hitting the <i>http(s)://&lt;app&gt;/nexusforge</i>
    ...
    /// <seealso cref="NexusForge.Dashboard"/>
    /// <seealso href="https://www.nuget.org/packages/NexusForge.Dashboard.Authorization/">
    /// NexusForge.Dashboard.Authorization Package
    /// </seealso>
    /// 
    ...
    public static class AppBuilderExtensions
    {
        ...
        /// </remarks>
        public static IAppBuilder UseNexusForgeServer([NotNull] this IAppBuilder builder)
        {
            return builder.UseNexusForgeServer(new BackgroundJobServerOptions());
        }
        ...
        /// Please see <see cref="AppBuilderExtensions"/> for details and examples.
        /// </remarks>
        public static IAppBuilder UseNexusForgeServer(
            [NotNull] this IAppBuilder builder, 
            [NotNull] params IBackgroundProcess[] additionalProcesses)
        {
            return builder.UseNexusForgeServer(JobStorage.Current, new BackgroundJobServerOptions(), additionalProcesses);
        }
        ...
        {
            return builder.UseNexusForgeServer(options, JobStorage.Current);
        }
        ...
        public static IAppBuilder UseNexusForgeServer(
            ...
            [NotNull] params IBackgroundProcess[] additionalProcesses)
        {
            return builder.UseNexusForgeServer(JobStorage.Current, options, additionalProcesses);
        }
        ...
        {
            return builder.UseNexusForgeServer(storage, options);
        }
            ...
            [NotNull] params IBackgroundProcess[] additionalProcesses)
        {
            ...
            return UseNexusForgeServer(builder, new BackgroundJobServer(options, storage, additionalProcesses));
        }
        ...
        /// the <c>/nexusforge</c> path, for the <see cref="JobStorage.Current"/> storage.
        /// </summary>
        /// <param name="builder">OWIN application builder.</param>
        /// 
        /// <exception cref="ArgumentNullException"><paramref name="builder"/> is null.</exception>
        ...
        /// Please see <see cref="AppBuilderExtensions"/> for details and examples.
        /// </remarks>
        public static IAppBuilder UseNexusForgeDashboard([NotNull] this IAppBuilder builder)
        {
            return builder.UseNexusForgeDashboard("/nexusforge");
        }
        ...
        /// </summary>
        /// <param name="builder">OWIN application builder.</param>
        /// <param name="pathMatch">Path prefix for middleware to use, e.g. "/nexusforge".</param>
        /// 
        /// <exception cref="ArgumentNullException"><paramref name="builder"/> is null.</exception>
        ...
        /// Please see <see cref="AppBuilderExtensions"/> for details and examples.
        /// </remarks>
        public static IAppBuilder UseNexusForgeDashboard(
            [NotNull] this IAppBuilder builder,
            [NotNull] string pathMatch)
        {
            return builder.UseNexusForgeDashboard(pathMatch, new DashboardOptions());
        }
        ...
        {
            return builder.UseNexusForgeDashboard(pathMatch, options, JobStorage.Current);
        }
        ...
        public static IAppBuilder UseNexusForgeDashboard(
            ...
            [NotNull] JobStorage storage)
        {
            return builder.UseNexusForgeDashboard(pathMatch, options, storage, null);
        }
                ...
                [CanBeNull] IOwinDashboardAntiforgery antiforgery)
        {
            ...
            builder.Map(pathMatch, subApp => subApp
                .UseOwin()
                .UseNexusForgeDashboard(options, storage, DashboardRoutes.Routes, antiforgery));
