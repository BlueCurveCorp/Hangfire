...
{
    /// <exclude />
    [Obsolete("Please use `IAppBuilder.UseNexusForgeDashboard` OWIN extension method instead. Will be removed in version 2.0.0.")]
    public static class DashboardOwinExtensions
    {
        ...
        internal static readonly string DefaultDashboardPath = "/nexusforge";
        internal static readonly string DefaultAppPath = "/";

        /// <summary>
        /// Maps dashboard to the app builder pipeline at "/nexusforge"
        /// with authorization filter that blocks all remote requests
        /// and <see cref="JobStorage.Current"/> storage instance.
        /// </summary>
        /// <param name="app">The app builder</param>
        [Obsolete("Please use `IAppBuilder.UseNexusForgeDashboard` OWIN extension method instead. Will be removed in version 2.0.0.")]
        public static void MapNexusForgeDashboard(this IAppBuilder app)
        {
            MapNexusForgeDashboard(app, DefaultDashboardPath, DefaultAppPath);
        }
        ...
        [Obsolete("Please use `IAppBuilder.UseNexusForgeDashboard` OWIN extension method instead. Will be removed in version 2.0.0.")]
        public static void MapNexusForgeDashboard(
            this IAppBuilder app,
            string dashboardPath)
        {
            MapNexusForgeDashboard(app, dashboardPath, DefaultAppPath, DefaultAuthorizationFilters);
        }
        ...
        public static void MapNexusForgeDashboard(
            ...
            string appPath)
        {
            MapNexusForgeDashboard(app, dashboardPath, appPath, DefaultAuthorizationFilters);
        }
        ...
        {
            MapNexusForgeDashboard(app, dashboardPath, appPath, authorizationFilters, JobStorage.Current);
        }
