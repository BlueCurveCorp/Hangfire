...
namespace NexusForge
{
    /// <exclude />
    /// <summary>
    /// Represents a configuration class for NexusForge components that
    ...
    public interface IBootstrapperConfiguration
    {
        ...
        [Obsolete("Please use `IAppBuilder.UseNexusForgeDashboard(\"/nexusforge\", new DashboardOptions { AuthorizationFilters = filters })` OWIN extension method instead. Will be removed in version 2.0.0.")]
        ...
        /// </summary>
        /// <param name="path">Dashboard path, '/nexusforge' by default</param>
        [Obsolete("Please use `IAppBuilder.UseNexusForgeDashboard(string pathMatch)` OWIN extension method instead. Will be removed in version 2.0.0.")]
        ...
        [Obsolete("Please use `IAppBuilder.UseNexusForgeDashboard(\"/nexusforge\", new DashboardOptions { AppPath = path })` OWIN extension method instead. Will be removed in version 2.0.0.")]
        ...
        [Obsolete("Please use `IAppBuilder.UseNexusForgeServer` OWIN extension method instead. Will be removed in version 2.0.0.")]
