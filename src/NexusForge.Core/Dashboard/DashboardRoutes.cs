...
namespace NexusForge.Dashboard
{
    ...
    public static class DashboardRoutes
    {
        ...
        static DashboardRoutes()
        {
            ...
            AddStylesheet(executingAssembly, GetContentResourceName("css", "nexusforge.css"));

            AddStylesheetDarkMode(executingAssembly, GetContentResourceName("css", "nexusforge-dark.css"));
            ...
            AddJavaScript(executingAssembly, GetContentResourceName("js", "nexusforge.js"));
