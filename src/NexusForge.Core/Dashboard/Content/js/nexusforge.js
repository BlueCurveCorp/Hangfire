(function (nexusforge) {
    ...
    nexusforge.config = {
        pollInterval: $("#nexusforgeConfig").data("pollinterval"),
        pollUrl: $("#nexusforgeConfig").data("pollurl"),
        locale: document.documentElement.lang,
        darkMode: $("#nexusforgeConfig").data("darkmode")
    };

    var colorScheme = "light";

    if (nexusforge.config.darkMode) {
        ...
        window.matchMedia('(prefers-color-scheme: dark)').addEventListener('change', e => {
            ...
            nexusforge.page.realtimeGraph.changeDatasetColorScheme(colorScheme);
            nexusforge.page.historyGraph.changeDatasetColorScheme(colorScheme);
        });
    }

    nexusforge.ErrorAlert = (function () {
    ...
    nexusforge.RealtimeGraph = (function() {
    ...
    nexusforge.HistoryGraph = (function() {
    ...
    nexusforge.StatisticsPoller = (function() {
            ...
            var intervalFunc = function() {
                try {
                    $.post(self._statisticsUrl, { metrics: self._metricsCallback() })
                        ...
                        .fail(function (xhr) {
                            var errorAlert = new NexusForge.ErrorAlert(
    ...
    nexusforge.Page = (function() {
        function Page(config) {
            this._metrics = new NexusForge.Metrics();

            var self = this;
            this._poller = new NexusForge.StatisticsPoller(
        ...
        Page.prototype._createRealtimeGraph = function(elementId, pollInterval) {
            ...
            if (realtimeElement) {
                ...
                var realtimeGraph = new NexusForge.RealtimeGraph(realtimeElement, succeeded, failed, deleted, succeededStr, failedStr, deletedStr, pollInterval);
        ...
        Page.prototype._createHistoryGraph = function(elementId) {
            ...
            if (historyElement) {
                ...
                return new NexusForge.HistoryGraph(historyElement, succeeded, failed, deleted, succeededStr, failedStr, deletedStr);
            }
...
})(window.NexusForge = window.NexusForge || {});

$(function () {
    NexusForge.page = new NexusForge.Page(NexusForge.config);
});
