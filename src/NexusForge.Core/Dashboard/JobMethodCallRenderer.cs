...
using NexusForge.Processing;

namespace NexusForge.Dashboard
{
    internal static class JobMethodCallRenderer
    {
        // Should not be converted to "readonly" to support https://github.com/NexusForgeIO/NexusForge/issues/1295
