...
namespace NexusForge.Dashboard
{
    ...
    {
        public static BuildFunc UseNexusForgeDashboard(
            ...
            [CanBeNull] IOwinDashboardAntiforgery antiforgery)
        {
            ...
            builder(_ => UseNexusForgeDashboard(options, storage, routes, antiforgery));

            return builder;
        }

        public static MidFunc UseNexusForgeDashboard(
            [NotNull] DashboardOptions options, 
            [NotNull] JobStorage storage, 
            [NotNull] RouteCollection routes,
            [CanBeNull] IOwinDashboardAntiforgery antiforgery)
