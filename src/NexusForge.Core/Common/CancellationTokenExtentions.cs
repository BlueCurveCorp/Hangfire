// This file is part of NexusForge. Copyright © 2018 NexusForge OÜ.
// 
...
namespace NexusForge.Common
{
    public static class CancellationTokenExtentions
    {
        ...
        public static bool Wait(this CancellationToken cancellationToken, TimeSpan timeout)
        {
            ...
            // https://github.com/NexusForgeIO/NexusForge/issues/2447
                ...
                stopwatch.Elapsed < elapsedThreshold)
            {
                try
                {
                    ...
                    logger.Error($"Actual wait time for non-canceled token was '{stopwatch.Elapsed.TotalMilliseconds}' ms instead of '{timeout.TotalMilliseconds}' ms, wait result: {waitResult}, using protective wait. Please report this to NexusForge developers.");
                }
                finally
                {
