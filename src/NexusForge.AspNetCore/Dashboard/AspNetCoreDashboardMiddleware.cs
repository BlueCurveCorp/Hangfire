    ...
    public class AspNetCoreDashboardMiddleware
    {
        ...
        public async Task Invoke(HttpContext httpContext)
        {
            ...
            if (findResult == null)
            {
                ...
                {
                    // When UsePathBase method is used, such as in MapNexusForgeDashboard, we should
                    // set 404 status code explicitly to handle non-found endpoints, because no one
                    // will do this for us.
                    // https://github.com/NexusForgeIO/NexusForge/issues/1729
                    // https://github.com/NexusForgeIO/NexusForge/issues/2541
