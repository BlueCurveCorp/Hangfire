...
{
    public static class NexusForgeApplicationBuilderExtensions
    {
        public static IApplicationBuilder UseNexusForgeDashboard(
            [NotNull] this IApplicationBuilder app,
            [NotNull] string pathMatch = "/nexusforge",
        ...
        [Obsolete("Please use IServiceCollection.AddNexusForgeServer extension method instead in the ConfigureServices method. Will be removed in 2.0.0.")]
#endif
        public static IApplicationBuilder UseNexusForgeServer(
            [NotNull] this IApplicationBuilder app,
            ...
            [CanBeNull] JobStorage storage = null)
        {
            ...
            services.RegisterNexusForgeServer(NexusForgeServiceCollectionExtensions.GetInternalServices(services, out var factory, out var stateChanger, out var performer)
...
#pragma warning restore 618
            ...
            [NotNull] Func<IBackgroundProcessingServer> serverFactory)
        {
            ...
            NexusForgeServiceCollectionExtensions.ThrowIfNotConfigured(app.ApplicationServices);
            app.ApplicationServices.RegisterNexusForgeServer(serverFactory());

            return app;
        }

        public static IServiceProvider RegisterNexusForgeServer(
