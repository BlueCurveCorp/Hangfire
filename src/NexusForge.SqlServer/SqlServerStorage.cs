    ...
    public class SqlServerStorage : JobStorage
    {
        ...
        private readonly Dictionary<string, bool> _features =
            new Dictionary<string, bool>(StringComparer.OrdinalIgnoreCase)
            {
                ...
                { JobStorageFeatures.Connection.TenantAwareDistributedLock, true },
                { JobStorageFeatures.Connection.PriorityAwareQueues, true },
                { JobStorageFeatures.Transaction.AcquireDistributedLock, true },
                { JobStorageFeatures.Transaction.TenantAwareDistributedLock, true },
...
#pragma warning restore 618
                        ...
                        System.Data.IsolationLevel.ReadCommitted))
                    {
                        ...
                        catch (Exception ex) when (ex.IsCatchableExceptionType())
                        {
                            ...
                            if (transaction.Connection != null)
                            {
                                ...
                                // https://github.com/NexusForgeIO/NexusForge/issues/1494
        ...
        private void Initialize()
        {
            ...
            if (_options.PrepareSchemaIfNecessary)
            {
                ...
                log.Info("Start installing NexusForge SQL objects...");
                ...
                {
                    log.WarnException("Was unable to perform the NexusForge schema migration due to an exception. Ignore this message unless you've just installed or upgraded NexusForge.", lastException);
                }
                else
                {
                    log.Info("NexusForge SQL objects installed.");
                }
            }
