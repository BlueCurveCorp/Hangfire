...
namespace NexusForge.SqlServer
{
    public class SqlServerDistributedLock : IDisposable
    {
        ...
        public SqlServerDistributedLock([NexusForge.Annotations.NotNull] SqlServerStorage storage, [NexusForge.Annotations.NotNull] string resource, TimeSpan timeout)
        {
