...
using NexusForge.SqlServer.Entities;
...
where j.Id = @jobId");
        ...
        public override void SetJobParameter(string id, string name, string value)
        {
            ...
            // [IX_NexusForge_JobParameter_JobIdAndName] index wasn't declared as unique,
            // to make our query resistant to (no matter what schema we are using):
            // 
            // https://github.com/NexusForgeIO/NexusForge/issues/1743 (deadlocks)
            // https://github.com/NexusForgeIO/NexusForge/issues/1741 (duplicate entries)
            // https://github.com/NexusForgeIO/NexusForge/issues/1693#issuecomment-697976133 (records aren't updated)
