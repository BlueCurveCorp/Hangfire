...
{
    public static class NexusForgeServiceCollectionExtensions
    {
        public static IServiceCollection AddNexusForge(
            [NotNull] this IServiceCollection services,
            [NotNull] Action<IGlobalConfiguration> configuration)
        {
            return AddNexusForge(services, (provider, config) => configuration(config));
        }
            ...
            [NotNull] Action<IServiceProvider, IGlobalConfiguration> configuration)
        {
            ...
            // IGlobalConfiguration serves as a marker indicating that NexusForge's services 
...
#if !NET451 && !NETSTANDARD1_3
        public static IServiceCollection AddNexusForgeServer(
            [NotNull] this IServiceCollection services,
            [NotNull] Action<BackgroundJobServerOptions> optionsAction)
        {
            ...
            return AddNexusForgeServerInner(services, null, null, (provider, options) => optionsAction(options));
        }
            ...
            [NotNull] Action<IServiceProvider, BackgroundJobServerOptions> optionsAction)
        {
            ...
            return AddNexusForgeServerInner(services, null, null, optionsAction);
        }
            ...
            [NotNull] JobStorage storage)
        {
            ...
            return AddNexusForgeServerInner(services, storage, null, optionsAction);
        }
            ...
            [NotNull] IEnumerable<IBackgroundProcess> additionalProcesses)
        {
            ...
            return AddNexusForgeServerInner(services, storage, additionalProcesses, optionsAction);
        }

        public static IServiceCollection AddNexusForgeServer([NotNull] this IServiceCollection services)
        {
            if (services == null) throw new ArgumentNullException(nameof(services));
            return AddNexusForgeServerInner(services, null, null);
        }
            ...
            [NotNull] JobStorage storage)
        {
            ...
            return AddNexusForgeServerInner(services, storage, null);
        }
            ...
            [NotNull] IEnumerable<IBackgroundProcess> additionalProcesses)
        {
            ...
            return AddNexusForgeServerInner(services, storage, additionalProcesses);
        }

        private static IServiceCollection AddNexusForgeServerInner(
        ...
        public static void ThrowIfNotConfigured(IServiceProvider serviceProvider)
        {
            ...
            if (configuration == null)
            {
                throw new InvalidOperationException(
                    "Unable to find the required services. Please add all the required services by calling 'IServiceCollection.AddNexusForge' inside the call to 'ConfigureServices(...)' in the application startup code.");
            }
        }
    }
}
