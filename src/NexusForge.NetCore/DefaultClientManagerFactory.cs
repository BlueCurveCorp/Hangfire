// This file is part of NexusForge. Copyright © 2021 NexusForge OÜ.
// 
...
namespace NexusForge
{
    internal sealed class DefaultClientManagerFactory : IBackgroundJobClientFactoryV2, IRecurringJobManagerFactoryV2
    {
        ...
        {
            if (NexusForgeServiceCollectionExtensions.GetInternalServices(_serviceProvider, out var factory, out var stateChanger, out _))
            {
        ...
        {
            if (NexusForgeServiceCollectionExtensions.GetInternalServices(_serviceProvider, out var factory, out _, out _))
            {
